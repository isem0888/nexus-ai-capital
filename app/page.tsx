...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-10 py-6 border-b border-slate-200 bg-white/80 backdrop-blur-md">
        ...
        <div className="flex items-center gap-8 text-slate-600">
          ...
          <a href="#metrics" className="hover:text-blue-600 transition">
            Metrics
          </a>
          ...
          <Link
            href="/invest"
            className="rounded-xl bg-gradient-to-r from-blue-600 to-violet-600 px-5 py-2 text-white hover:from-blue-500 hover:to-violet-500 transition"
          >
            Launch Platform
          </Link>
        </div>
      ...
      <section
        id="home"
        className="relative z-10 max-w-7xl mx-auto px-10 pt-40 pb-32"
      >
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-blue-500/20 bg-blue-50 text-blue-600 mb-8">
            ...
            <div className="flex gap-8 mt-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-slate-900">99ms</div>
                  <div className="text-sm text-slate-500">Execution</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">AI Efficiency</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-12">
              <Link
                href="/invest"
                className="rounded-xl bg-gradient-to-r from-blue-600 to-violet-600 px-8 py-4 text-lg font-semibold hover:from-blue-500 hover:to-violet-500 transition shadow-lg shadow-blue-600/25 text-white"
              >
                Launch Platform
              </Link>
              <a
                href="#agents"
                className="rounded-xl border border-slate-300 px-8 py-4 text-lg hover:border-blue-500 hover:text-blue-600 transition"
              >
                Explore Agents
              </a>
            </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            {/* Orbits */}
            <div className="absolute h-[420px] w-[420px] rounded-full border border-blue-500/20 animate-[spin_30s_linear_infinite]" />
            <div className="absolute h-[520px] w-[520px] rounded-full border border-violet-500/10 animate-[spin_45s_linear_infinite_reverse]" />

            {/* Glow */}
            <div className="absolute h-80 w-80 rounded-full bg-blue-500 blur-[120px] opacity-20" />

            {/* 3D Coin */}
            <div className="relative flex items-center justify-center">
              <div
                className="relative w-64 h-64 rounded-full flex items-center justify-center animate-[float_6s_ease-in-out_infinite]"
                style={{
                  background:
              ...
              >
                <div className="absolute inset-2 rounded-full bg-gradient-to-br from-white to-slate-100 flex items-center justify-center">
                  <span className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-blue-600 to-violet-600">
                    N
                  </span>
                </div>
              </div>
            ...
            <div
              className="absolute top-8 left-0 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl animate-[float_5s_ease-in-out_infinite]"
            ...
            <div
              className="absolute top-1/3 right-0 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl animate-[float_5s_ease-in-out_infinite]"
            ...
            <div
              className="absolute bottom-20 left-8 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl animate-[float_5s_ease-in-out_infinite]"
            ...
            <div
              className="absolute bottom-8 right-8 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl animate-[float_5s_ease-in-out_infinite]"
      ...
      <section
        id="agents"
        className="relative z-10 max-w-7xl mx-auto px-10 py-32"
      >
        <div className="text-center mb-16">
          <div className="text-blue-600 uppercase tracking-[4px] text-sm mb-4 font-semibold">
            AI AGENTS ECOSYSTEM
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Market Scanner */}
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl hover:border-blue-500/50 hover:-translate-y-1 transition-all duration-300">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center text-blue-600 mb-6">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <h3 className="text-xl font-bold mb-3">Market Scanner</h3>
          ...
          {/* Arbitrage Agent */}
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl hover:border-violet-500/50 hover:-translate-y-1 transition-all duration-300">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-100 to-violet-50 flex items-center justify-center text-violet-600 mb-6">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <h3 className="text-xl font-bold mb-3">Arbitrage Agent</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          {/* Risk Manager */}
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl hover:border-green-500/50 hover:-translate-y-1 transition-all duration-300">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-100 to-green-50 flex items-center justify-center text-green-600 mb-6">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <h3 className="text-xl font-bold mb-3">Risk Manager</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
          ...
          {/* Execution Agent */}
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl hover:border-amber-500/50 hover:-translate-y-1 transition-all duration-300">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-100 to-amber-50 flex items-center justify-center text-amber-600 mb-6">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <h3 className="text-xl font-bold mb-3">Execution Agent</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
...
<section id="strategies" className="relative z-10 max-w-7xl mx-auto px-10 py-32">
  <div className="text-center mb-16">
    <div className="text-blue-600 uppercase tracking-[4px] text-sm mb-4 font-semibold">
      AI TRADING STRATEGIES
    </div>
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
    {/* Quant Momentum AI */}
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-blue-500 transition-all duration-300">
      ...
      <h3 className="text-2xl font-bold mb-2">Quant Momentum AI</h3>
      <p className="text-slate-600 text-sm mb-6">
        Captures medium and large directional moves by identifying strong trends before they become obvious to the market.
      </p>

      <div className="space-y-3 mb-6">
        <div>
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1.5">Indicators</div>
          <div className="flex flex-wrap gap-1.5">
            {["RSI", "CCI", "MACD", "Volume Profile", "Open Interest"].map((tag) => (
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {["Trend Acceleration", "Liquidity Inflow", "Buyer Strength"].map((tag) => (
      ...
      <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-200">
        <div>
          ...
          <div className="font-bold text-slate-900 text-sm">18-24%</div>
        ...
        <div>
          ...
          <div className="font-bold text-blue-600 text-sm">94%</div>
        </div>
      </div>
    </div>

    {/* Arbitrage Engine */}
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-violet-500 transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
      ...
      <h3 className="text-2xl font-bold mb-2">Arbitrage Engine</h3>
      <p className="text-slate-600 text-sm mb-6">
    ...
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-blue-500 transition-all duration-300">
      ...
      <h3 className="text-2xl font-bold mb-2">Liquidity Hunter</h3>
      <p className="text-slate-600 text-sm mb-6">
        Targets institutional liquidity zones by analyzing liquidations, stops, and order book density.
      </p>
      ...
      <div className="space-y-3 mb-6">
        <div>
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1.5">AI Analyzes</div>
          <div className="flex flex-wrap gap-1.5">
            {["Liquidations", "Stop Clusters", "Order Density"].map((tag) => (
              <span key={tag} className="px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 text-xs">
                {tag}
              </span>
            ))}
    ...
    {/* Market Making Agent */}
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-green-500 transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
      ...
      <h3 className="text-2xl font-bold mb-2">Market Making Agent</h3>
      <p className="text-slate-600 text-sm mb-6">
        Generates yield from market inefficiencies by providing liquidity and capturing the spread.
      </p>
      ...
      <div className="space-y-3 mb-6">
        <div>
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1.5">AI Analyzes</div>
          <div className="flex flex-wrap gap-1.5">
            {["Order Book", "Market Depth", "Volatility"].map((tag) => (
      ...
      <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-200">
        <div>
          <div className="text-xs text-slate-500 mb-1">Return</div>
          <div className="font-bold text-slate-900 text-sm">10-16%</div>
          <div className="text-xs text-slate-500">APY</div>
        </div>
        <div>
          <div className="text-xs text-slate-500 mb-1">Risk</div>
        ...
        <div>
          <div className="text-xs text-slate-500 mb-1">AI Confidence</div>
          <div className="font-bold text-green-600 text-sm">96%</div>
        </div>
      </div>
    </div>
    ...
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-violet-500 transition-all duration-300">
      ...
      <h3 className="text-2xl font-bold mb-2">DeFi Yield Optimizer</h3>
      <p className="text-slate-600 text-sm mb-6">
        Automatically reallocates capital to top yields across lending, staking, and liquidity pools.
      </p>
      ...
      <div className="space-y-3 mb-6">
        <div>
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1.5">AI Analyzes</div>
          <div className="flex flex-wrap gap-1.5">
            {["Lending", "Staking", "Liquidity Pools"].map((tag) => (
              <span key={tag} className="px-2 py-0.5 rounded-md bg-violet-50 text-violet-700 text-xs">
                {tag}
              </span>
            ))}
      ...
      <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-200">
        <div>
          <div className="text-xs text-slate-500 mb-1">Return</div>
          <div className="font-bold text-slate-900 text-sm">12-20%</div>
          <div className="text-xs text-slate-500">APY</div>
        </div>
        <div>
          <div className="text-xs text-slate-500 mb-1">Risk</div>
    ...
    {/* Risk Guardian */}
    <div className="rounded-3xl bg-white shadow-xl border border-slate-200 p-8 hover:-translate-y-2 hover:border-red-500 transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
      ...
      <h3 className="text-2xl font-bold mb-2">Risk Guardian</h3>
      <p className="text-slate-600 text-sm mb-6">
        Reduces portfolio risk during adverse conditions through volatility, correlation, and drawdown analysis.
      </p>
      ...
      <div className="space-y-3 mb-6">
        <div>
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1.5">AI Analyzes</div>
          <div className="flex flex-wrap gap-1.5">
            {["Volatility", "Correlations", "Drawdowns"].map((tag) => (
      ...
      <section
        id="metrics"
        className="relative z-10 max-w-7xl mx-auto px-10 py-24"
      >
        <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-blue-50 to-violet-50 p-16">
          <div className="text-center mb-12">
            <div className="text-blue-600 uppercase tracking-[4px] text-sm mb-4 font-semibold">
              LIVE METRICS
            </div>
            <h2 className="text-5xl font-bold">Real-Time Performance</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-slate-600">Signals Generated</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-violet-600 mb-2">
                {dashboardData.assetsMonitored.toLocaleString()}
              </div>
              <div className="text-slate-600">Markets Monitored</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-green-600 mb-2">
                {dashboardData.activeStrategies}
              </div>
              <div className="text-slate-600">Active AI Agents</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-amber-600 mb-2">
                {dashboardData.executionSpeed}ms
              </div>
              <div className="text-slate-600">Average Execution</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-10 py-24">
        <div className="text-center mb-12">
          <div className="text-blue-600 uppercase tracking-[4px] mb-3">
            LIVE AI CONTROL CENTER
          </div>
          <h2 className="text-6xl font-bold">AI Trading Dashboard</h2>
        </div>
...
{/* About Nexus */}
<section id="about" className="relative z-10 max-w-7xl mx-auto px-10 py-32">
  {/* Header */}
  ...
  <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
    ...
    <div className="space-y-12">
      {/* What We Do */}
      <div>
        <h3 className="text-2xl font-bold mb-6 text-slate-900">What We Do</h3>
      ...
      <div>
        ...
        <div className="space-y-4">
          {[
            ...
            >
              <div className="font-bold text-slate-900 mb-1">{agent.name}</div>
              <div className="text-sm text-slate-600">{agent.desc}</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="lg:sticky lg:top-32">
      <div className="rounded-3xl border border-blue-500/20 bg-gradient-to-br from-slate-800 to-slate-950 p-10 shadow-2xl">
        <div className="text-blue-400 uppercase tracking-widest text-sm mb-2">
          NEXUS CORE
        </div>
...
<div className="grid md:grid-cols-2 gap-6 mb-24">
  {/* Mission */}
  <div className="rounded-3xl bg-gradient-to-br from-slate-800 to-slate-950 p-10 shadow-2xl">
    <div className="text-blue-400 uppercase tracking-widest text-sm mb-4">
      Our Mission
    </div>
  ...
  {/* Corporate Backing */}
  <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-violet-600 p-10 shadow-2xl relative overflow-hidden">
    {/* Декор */}
    ...
    <div className="relative">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="text-2xl font-bold text-white">NEXO</h3>
          <div className="text-white/70 text-sm">Parent Company</div>
        </div>
      </div>
  ...
  <div className="mb-24">
    <div className="text-center mb-12">
      <div className="text-blue-600 uppercase tracking-widest text-sm mb-4 font-semibold">
        Why Nexus
      </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        ...
        <div
          key={item.title}
          className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md hover:border-blue-500 hover:shadow-lg transition-all duration-300"
        >
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
    <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-md">
      <div className="text-5xl font-bold text-blue-600 mb-2">12,847+</div>
      <div className="text-slate-600">Signals Generated Daily</div>
    </div>
    <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-md">
      <div className="text-5xl font-bold text-blue-600 mb-2">4,391+</div>
      <div className="text-slate-600">Assets Monitored</div>
    </div>
    <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-md">
      <div className="text-5xl font-bold text-blue-600 mb-2">27+</div>
      <div className="text-slate-600">Active Strategies</div>
    </div>
    <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-md">
      <div className="text-5xl font-bold text-green-600 mb-2">99ms</div>
      <div className="text-slate-600">Average Execution Time</div>
    </div>
  </div>
</section>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 md:px-10 py-24">
        <div className="rounded-3xl border border-blue-500/20 bg-gradient-to-br from-blue-50 via-white to-white p-8 md:p-12 relative overflow-hidden shadow-xl">
          {/* Decor */}
          <div className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-blue-500/10 blur-[100px]" />

          <div className="relative flex flex-col md:flex-row items-start md:items-center gap-8">
            <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center shadow-lg shadow-blue-500/30">
              <svg
            ...
            <div className="flex-1">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 font-mono text-sm text-slate-700 break-all mb-6">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-violet-600 text-white px-6 py-3 font-semibold hover:from-blue-500 hover:to-violet-500 transition"
              >
                View on Arkham
                <svg
                  className="w-4 h-4"
      ...
      <div className="flex items-center gap-2">
        {[
          ...
          <a
            ...
            href={s.href}
            aria-label={s.name}
            className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-600 hover:text-blue-600 hover:border-blue-500 hover:bg-blue-50 transition"
          >
    ...
    <div className="mt-8 pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-700">NEXO</span>
        </div>
      ...
      <div className="flex items-center gap-6 text-xs text-slate-500">
        ...
        <a href="#" className="hover:text-blue-600 transition">Regulatory</a>
      </div>
    </div>
  </div>
</footer>
