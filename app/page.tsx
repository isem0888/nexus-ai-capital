    ...
    >
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative h-[420px] md:h-[580px] flex items-center justify-center">
            ...
            {/* Card: Signals */}
            <div className="absolute top-6 left-0 z-20 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl animate-[float_5s_ease-in-out_infinite]" style={{ animationDelay: "0s" }}>
            ...
            {/* Card: BTC */}
            <div className="absolute top-8 right-0 z-20 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl animate-[float_5s_ease-in-out_infinite]" style={{ animationDelay: "0.8s" }}>
              <div className="flex items-center gap-2.5">
            ...
            {/* Card: Assets */}
            <div className="absolute top-1/2 -translate-y-1/2 right-0 z-20 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl animate-[float_5s_ease-in-out_infinite]" style={{ animationDelay: "1.4s" }}>
              <div className="flex items-center gap-2.5">
            ...
            {/* Card: ETH */}
            <div className="absolute bottom-16 left-0 z-20 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl animate-[float_5s_ease-in-out_infinite]" style={{ animationDelay: "2s" }}>
              <div className="flex items-center gap-2.5">
            ...
            {/* Card: AI Efficiency */}
            <div className="absolute bottom-4 right-0 z-20 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl animate-[float_5s_ease-in-out_infinite]" style={{ animationDelay: "2.6s" }}>
              <div className="flex items-center gap-2.5">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[
            { title: "Market Scanner", desc: "Scans exchanges and liquidity flows.", color: "blue", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
            { title: "Arbitrage Agent", desc: "Finds pricing inefficiencies across markets.", color: "violet", icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
            { title: "Risk Manager", desc: "Controls exposure and protects capital.", color: "green", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
            { title: "Execution Agent", desc: "Optimizes order execution.", color: "amber", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
          ].map((agent) => (
            <div
              key={agent.title}
      ...
      <section ref={s3.ref} id="strategies" className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 py-20 md:py-32" style={{ opacity: s3.visible ? 1 : 0, transform: s3.visible ? "translateY(0)" : "translateY(40px)", transition: "opacity 0.7s ease 0.1s, transform 0.7s ease 0.1s" }}>
        <div className="text-center mb-12 md:mb-16">
          <div className="text-blue-400 uppercase tracking-[4px] text-xs md:text-sm mb-3 md:mb-4 font-semibold">AI TRADING STRATEGIES</div>
          <h2 className="text-3xl md:text-5xl font-bold text-white">
            Ecosystem of{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-violet-400">6 AI Strategies</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {[
            { title: "Macro Intelligence AI", desc: "Captures macroeconomic trends and cross-asset opportunities through AI-driven analysis of global market indicators and institutional flows.", tags: ["Macro Indicators", "Cross-Asset Flows", "Institutional Activity"], tagColor: "blue", badgeColor: "blue", returnVal: "15-22%", risk: "Medium", riskColor: "amber", confidence: "93%" },
            { title: "Risk Control AI", desc: "Advanced risk management system that dynamically adjusts portfolio exposure based on volatility regimes, correlation shifts, and drawdown thresholds.", tags: ["Volatility Regimes", "Correlation Shifts", "Drawdown Thresholds"], tagColor: "red", badgeColor: "red", returnVal: "Protection", risk: "Very Low", riskColor: "green", confidence: "98%" },
            { title: "Arbitrage Engine", desc: "Low-risk market neutral opportunities through price discrepancies across major exchanges.", tags: ["Price Gaps", "Latency", "Order Flow"], tagColor: "violet", badgeColor: "violet", returnVal: "8-12%", risk: "Low", riskColor: "green", confidence: "97%" },
            { title: "Dual Currency Yield Agent", desc: "AI-powered dual investment strategy targeting enhanced annual returns through dynamic market positioning and yield optimization.", tags: ["Market Positioning", "Yield Curves", "Volatility Surfaces"], tagColor: "blue", badgeColor: "blue", returnVal: "12-18%", risk: "Medium", riskColor: "amber", confidence: "91%" },
            { title: "Options Income Agent", desc: "Automated options trading engine focused on premium generation, volatility management, and risk-controlled income strategies.", tags: ["Implied Volatility", "Greeks", "Premium Cycles"], tagColor: "violet", badgeColor: "violet", returnVal: "14-20%", risk: "Med-High", riskColor: "orange", confidence: "89%" },
            { title: "Liquidity Mining Agent", desc: "Algorithmic liquidity deployment across decentralized finance ecosystems to maximize rewards, fees, and capital efficiency.", tags: ["Pool Depth", "Fee Structures", "Impermanent Loss"], tagColor: "green", badgeColor: "green", returnVal: "16-24%", risk: "Medium", riskColor: "amber", confidence: "87%" },
          ].map((s) => (
            <div key={s.title} className="rounded-3xl bg-slate-900/60 backdrop-blur-xl shadow-xl border border-blue-500/20 p-6 md:p-8 hover:-translate-y-2 hover:border-blue-400 transition-all duration-300">
              ...
              <div className="space-y-3 mb-4 md:mb-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {s.tags.map((tag) => (
                      <span key={tag} className={`px-2 py-0.5 rounded-md bg-${s.tagColor}-500/20 text-${s.tagColor}-300 text-xs`}>{tag}</span>
                    ))}
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-700">
                <div><div className="text-xs text-slate-500 mb-1">Return</div><div className="font-bold text-white text-sm">{s.returnVal}</div><div className="text-xs text-slate-500">APY</div></div>
                <div><div className="text-xs text-slate-500 mb-1">Risk</div><div className={`font-bold text-${s.riskColor}-400 text-sm`}>{s.risk}</div></div>
                <div><div className="text-xs text-slate-500 mb-1">AI Confidence</div><div className={`font-bold text-${s.badgeColor}-400 text-sm`}>{s.confidence}</div></div>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* Live Metrics */}
      <section ref={s4.ref} style={{ opacity: s4.visible ? 1 : 0, transform: s4.visible ? "translateY(0)" : "translateY(40px)", transition: "opacity 0.8s ease, transform 0.8s ease" }} id="metrics" className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24">
        <div className="rounded-3xl border border-blue-500/20 bg-slate-900/60 backdrop-blur-xl p-8 md:p-16">
          <div className="text-center mb-8 md:mb-12">
            <div className="text-blue-400 uppercase tracking-[4px] text-xs md:text-sm mb-3 md:mb-4 font-semibold">LIVE METRICS</div>
            <h2 className="text-3xl md:text-5xl font-bold text-white">Real-Time Performance</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div className="text-center"><div className="text-3xl md:text-5xl font-bold text-blue-400 mb-2">{dashboardData.signalsToday.toLocaleString()}</div><div className="text-slate-400 text-sm md:text-base">Signals Generated</div></div>
            <div className="text-center"><div className="text-3xl md:text-5xl font-bold text-violet-400 mb-2">{dashboardData.assetsMonitored.toLocaleString()}</div><div className="text-slate-400 text-sm md:text-base">Markets Monitored</div></div>
            <div className="text-center"><div className="text-3xl md:text-5xl font-bold text-green-400 mb-2">{dashboardData.activeStrategies}</div><div className="text-slate-400 text-sm md:text-base">Active AI Agents</div></div>
            <div className="text-center"><div className="text-3xl md:text-5xl font-bold text-amber-400 mb-2">{dashboardData.executionSpeed}ms</div><div className="text-slate-400 text-sm md:text-base">Average Execution</div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={s5.ref} className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24" style={{ opacity: s5.visible ? 1 : 0, transform: s5.visible ? "translateY(0)" : "translateY(40px)", transition: "opacity 0.7s ease, transform 0.7s ease" }}>
        <div className="text-center mb-8 md:mb-12">
          <div className="text-blue-400 uppercase tracking-[4px] text-xs md:text-sm mb-2 md:mb-3">LIVE AI CONTROL CENTER</div>
            ...
            <div className="bg-slate-950/60 rounded-2xl p-6 md:p-8 border border-blue-500/20">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-green-400 font-semibold text-sm md:text-base">LIVE ACTIVITY LOG</span>
                </div>
                <div className="text-xs text-slate-500">{dashboardData.logs.length} events</div>
              </div>
              <div className="space-y-3 text-slate-300 text-xs md:text-sm max-h-[400px] overflow-y-auto">
                {dashboardData.logs.map((log, index) => (
                  <div key={index} className="flex gap-3 items-start">
                    <span className="text-slate-500 font-mono text-xs flex-shrink-0">{log.time}</span>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className={`text-xs font-semibold px-2 py-0.5 rounded ${
                          log.bot === 'Macro' ? 'bg-blue-500/20 text-blue-300'
                          : log.bot === 'Risk' ? 'bg-red-500/20 text-red-300'
                          : log.bot === 'Arbitrage' ? 'bg-violet-500/20 text-violet-300'
                          : log.bot === 'Dual' ? 'bg-cyan-500/20 text-cyan-300'
                          : log.bot === 'Options' ? 'bg-purple-500/20 text-purple-300'
                ...
                {[
                  ...
                  <div key={item.label}>
                    ...
                    <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                      <div className={`h-2 ${item.bar} rounded-full transition-all duration-1000`} style={{ width: `${item.value}%` }} />
                    </div>
                  </div>
                ))}
                <div className="pt-6 border-t border-slate-700">
                  <div className="text-xs uppercase tracking-wider text-slate-500 font-semibold mb-3">Active Strategies</div>
              ...
              <tbody className="divide-y divide-slate-800/60">
                {agentPerformance.map((row) => (
                  <tr key={row.agent} className="hover:bg-slate-800/20 transition">
                    <td className="py-3"><span className={`font-semibold ${row.color}`}>{row.agent}</span></td>
      ...
      <section ref={s7.ref} id="about" className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 py-20 md:py-32" style={{ opacity: s7.visible ? 1 : 0, transform: s7.visible ? "translateY(0)" : "translateY(40px)", transition: "opacity 0.8s ease, transform 0.8s ease" }}>
        <div className="text-center mb-12 md:mb-20">
          <div className="text-blue-400 uppercase tracking-[4px] text-xs md:text-sm mb-3 md:mb-4 font-semibold">About Nexus</div>
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-white">
            Building the Future of<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Financial Intelligence</span>
          </h2>
          <p className="text-slate-300 text-base md:text-xl max-w-3xl mx-auto leading-relaxed">
            Nexus is an AI-driven trading infrastructure designed to discover, evaluate and execute opportunities across global digital asset markets.
          </p>
          <p className="text-slate-400 text-sm md:text-lg max-w-3xl mx-auto leading-relaxed mt-3 md:mt-4">
            Unlike traditional trading systems that rely on fixed rules, Nexus operates through a network of specialized AI agents capable of adapting to changing market conditions in real time.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start mb-16 md:mb-24">
          <div className="space-y-8 md:space-y-12">
            <div>
              ...
              <p className="text-slate-300 mb-4 md:mb-6 leading-relaxed text-sm md:text-base">
                Nexus continuously monitors global markets to identify profitable opportunities and manage risk automatically.
              </p>
              <div className="space-y-3">
                {["Cryptocurrency Markets","Derivatives Markets","DeFi Protocols","Liquidity Flows","Market Sentiment","On-Chain Activity"].map((item) => (
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-white">AI Agent Architecture</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={agent.name} className="rounded-xl border border-blue-500/20 bg-slate-900/60 backdrop-blur-xl p-4 shadow-md hover:border-blue-400 hover:shadow-lg transition">
          ...
          <div className="lg:sticky lg:top-32">
            <div className="rounded-3xl border border-blue-500/30 bg-slate-900/80 backdrop-blur-xl p-6 md:p-10 shadow-2xl">
              <div className="text-blue-400 uppercase tracking-widest text-xs md:text-sm mb-2">NEXUS CORE</div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 md:mb-8">Autonomous Trading Intelligence</h3>
              ...
              <div className="border-t border-slate-700 pt-6 md:pt-8">
                <div className="text-slate-500 uppercase tracking-wider text-xs mb-4">Technology Stack</div>
                <div className="space-y-3">
                  {[
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-16 md:mb-24">
          <div className="rounded-3xl bg-slate-900/80 backdrop-blur-xl p-6 md:p-10 shadow-2xl border border-blue-500/20">
            <div className="text-blue-400 uppercase tracking-widest text-xs md:text-sm mb-3 md:mb-4">Our Mission</div>
            <h3 className="text-xl md:text-3xl font-bold text-white mb-3 md:mb-4">Creating a fully autonomous financial intelligence network</h3>
            <p className="text-slate-400 leading-relaxed text-sm md:text-base">
              Our mission is to create a fully autonomous financial intelligence network capable of identifying opportunities faster than traditional market participants while maintaining strict risk control.
            </p>
          </div>
          <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-violet-600 p-6 md:p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-white/70 uppercase tracking-widest text-xs md:text-sm mb-3 md:mb-4">Corporate Backing</div>
        ...
        <div className="mb-16 md:mb-24">
          <div className="text-center mb-8 md:mb-12">
            <div className="text-blue-400 uppercase tracking-widest text-xs md:text-sm mb-3 md:mb-4 font-semibold">Why Nexus</div>
            <h3 className="text-2xl md:text-4xl font-bold text-white">What Makes Us Different</h3>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              { title: "24/7 Monitoring", desc: "Markets never sleep. Neither do our AI agents.", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
              { title: "Multi-Agent System", desc: "Independent AI agents collaborate to make decisions.", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z" },
              { title: "Data-Driven Decisions", desc: "No emotions. No guesswork. Only data.", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
              { title: "Continuous Learning", desc: "Models evolve as market conditions change.", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
            ].map((item) => (
              <div key={item.title} className="rounded-2xl border border-blue-500/20 bg-slate-900/60 backdrop-blur-xl p-5 md:p-6 shadow-md hover:border-blue-400 hover:shadow-lg transition-all duration-300">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-blue-500/20 flex items-center justify-center text-blue-400 mb-3 md:mb-4">
                  <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={item.icon} /></svg>
                </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[
            ...
            <div key={stat.label} className="rounded-2xl border border-blue-500/20 bg-slate-900/60 backdrop-blur-xl p-6 md:p-8 text-center shadow-md">
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-300 mb-4 md:mb-6 max-w-xl text-sm md:text-base">
                Our treasury wallet is publicly verifiable. Every deposit, every transaction — fully transparent on-chain.
              </p>
              <div className="rounded-xl border border-blue-500/20 bg-slate-950/60 p-3 md:p-4 font-mono text-xs md:text-sm text-slate-300 break-all mb-4 md:mb-6">
                ...
                <span className="text-blue-400">nexo_treasury_verified • arkm.com/explorer/entity/nexo</span>
              </div>
              <a
      ...
      <footer className="relative z-10 border-t border-slate-800 mt-12 md:mt-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10 py-8 md:py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center font-black text-white">N</div>
              <div>
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                <a key={s.name} href={s.href} aria-label={s.name} className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-slate-700 flex items-center justify-center text-slate-400 hover:text-blue-400 hover:border-blue-400 hover:bg-blue-500/10 transition">
          ...
          <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
            <div className="flex items-center gap-3">
              <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Powered by</div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center text-white text-xs font-black">N</div>
                <span className="font-bold text-slate-300 text-sm md:text-base">NEXO</span>
              </div>
              <div className="text-xs text-slate-500 hidden md:block">— Leading Crypto Lending Platform</div>
            </div>
